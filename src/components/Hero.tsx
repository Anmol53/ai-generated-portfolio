...
export function Hero() {
  return (
    <Section className="min-h-screen flex items-center bg-gradient-to-b from-black to-gray-900">
      <Container maxWidth="xl">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          ...
          <Link
            ...
            external
            className={cn(
              "px-5 py-2.5 bg-gradient-to-r from-gray-800 to-gray-700 text-gray-300",
              "rounded-xl hover:text-white ring-1 ring-gray-700 hover:ring-gray-600",
        ...
        <div className="flex justify-center gap-4 sm:gap-6">
          ...
          <Link
            ...
            external
            className="text-gray-400 hover:text-[#0A66C2] p-2 hover:bg-gray-800/50 rounded-lg"
          >
          ...
          <Link
            ...
            external
            className="text-gray-400 hover:text-[#2962FF] p-2 hover:bg-gray-800/50 rounded-lg"
          >
            <Icon icon={SiHashnode} size="lg" />
          </Link>
          <Link
            href="mailto:anmol.agrawal53@gmail.com"
            className="text-gray-400 hover:text-[#EA4335] p-2 hover:bg-gray-800/50 rounded-lg"
          >
