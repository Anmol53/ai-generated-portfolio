      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            className="w-32 h-32 rounded-full overflow-hidden mb-8 mx-auto"
          >
            <img
          ...
          <div className="text-xl sm:text-2xl text-gray-700 dark:text-gray-300 mb-8 text-center">
            <TypeAnimation
              sequence={[
          ...
          <div className="prose dark:prose-invert max-w-none mb-8 text-center">
            <p className="text-lg text-gray-700 dark:text-gray-300">
              A passionate Software Developer with over 3 years of experience in
